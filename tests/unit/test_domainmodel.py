...
class TestUser:
    ...
    def test_track_methods(self):
        ...
        assert user1.tracks == [track1, track2, track3]

        track1_copy = Track(1, "Shivers")
        user1.add_track(track1_copy)
        assert len(user1.tracks) == 3

    def test_review_methods(self):
        """Test add_review() and remove_review() methods"""
        user1 = User(7232, "gavi", "gavi9281")
        track1 = Track(2, "Heat Waves")
        review1 = Review(track1, "review 1", 2, user1)
        review2 = Review(track1, "review 2", 3, user1)
        review3 = Review(track1, "review 3", 5, user1)
